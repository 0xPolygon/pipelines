...
class TaskdefCreator:
    ...
    def __init__(self):
        ...
        parser.add_argument("-tt", "--taskdef_template", type=str,
                            help="Template json file to be used"
        )
        parser.add_argument("-acc", "--account_number", type=str,
    ...
    def _subtitute_data(self, user_data: dict, sub: str):
        ...
        if sub == "app_name":
            if not data_read and self.args.app_name:
                data_read = self.args.app_name
    ...
    def create_taskdef_file(self, account_number: str):
        ...
        with open(file_path, "r") as fp:
            print("File data:", fp.read().replace(account_number, "****"))
    ...
    def substitute_values(self):
        ...
        if user_data:
            if user_data.get("account_number") is None and self.args.account_number:
                user_data["account_number"] = self.args.account_number
