...
const axios_1 = __importDefault(__nccwpck_require__(5691));
const errors_1 = __nccwpck_require__(4568);
const instrument_1 = __nccwpck_require__(9446);
/**
...
var errors_1 = __nccwpck_require__(4568);
Object.defineProperty(exports, "ErrorCode", ({ enumerable: true, get: function () { return errors_1.ErrorCode; } }));
var IncomingWebhook_1 = __nccwpck_require__(4986);
...
const packageJson = __nccwpck_require__(2291);
/**
...
const FormData$1 = __nccwpck_require__(2031);
...
const webhook_1 = __nccwpck_require__(7743);
...
const pr = JSON.parse((0, node_fs_1.readFileSync)((0, node_path_1.join)(process.env['GITHUB_WORKSPACE'] ?? '.', 'pr.json'), 'utf8'));
if (!pr.merged_by) {
...
const webhook = new webhook_1.IncomingWebhook(slackUrl);
const blocks = [
    {
        type: 'header',
